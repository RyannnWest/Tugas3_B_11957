...
st.markdown("""
                <div class="center">
                    <img src="https://gifsec.com/wp-content/uploads/2022/09/welcome-gif-3.gif" alt="Welcome Image">
            """, unsafe_allow_html=True)

st.markdown("<h1 style='text-align: center; color: #4CAF50;'>Prediksi IPK - 11957</h1>", unsafe_allow_html=True)
...
if uploaded_file is not None:
    ...
    model_directory = r'D:\Funiversity\Sem5\ML\Tugas3_B_11957'
    ...
    if os.path.exists(model_path):
        ...
        ind3 = st.sidebar.number_input("Nilai Bahasa Indonesia Semester 2.1", 70.0, 99.0)
        ...
        if st.sidebar.button("Prediksi"):
            ...
            st.write(f"<h3 style='text-align: center; color: #ACF456;'>Prediksi IPK adalah: {SVR_model_predict[0]:.2f}</h3>", unsafe_allow_html=True)
    else:
